...
const TokenDisplay: React.FC<TokenDisplayProps> = ({isRunning, isDebubg, isBuying}) => {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-2/3">
            <div className="rounded-t-lg w-full overflow-hidden shadow-md">
                <table className="w-full bg-white">
                    <thead className="bg-orange-500 text-sky-50 h-10">
                    ...
                    {tokens.length === 0 && !isLoading ? (
                        <tr>
                            <td className="pl-2">No token fetch</td>
                        </tr>
                    ) : (
                        <>
                            ...
                            {isLoading && (
                                <tr>
                                    <td className="pl-2">Loading tokens...</td>
                                </tr>
                            )}
                        </>
                    )}
